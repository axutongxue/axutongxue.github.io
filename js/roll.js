...
document.write('<style>#'+id+'{height:50px;overflow:hidden;width:290px;border:dashed 0.5px;margin: 4 auto 4 auto;}.'+roll+' li{font-size:9px;text-indent:-35px;padding-top:4px}.icon{width:25px;margin-right:4;vertical-align:-40%}</style>');
